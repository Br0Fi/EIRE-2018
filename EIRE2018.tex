...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\textwidth]{EIRE2018Dateien/Tag1/sinusbessel-bilder/SinusBesselc} %hab's kleiner gemacht, weil es so heslig ist.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\textwidth]{EIRE2018Dateien/Tag1/lissajous-bilder/Lissajousd} %hab's kleiner gemacht, weil war zu groß
...
<<<<<<< HEAD
	\subsubsection{Erzeugung eines amplitudenmodulierten Signals} %TODO hier ansetzen mit EIRE2018Dateien/Tag3/Soundkarteoutoszi
=======
	\subsubsection{Erzeugung} %EIRE2018Dateien/Tag3/Soundkarteoutoszi
