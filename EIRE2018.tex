...
\fi
	...
	Innerhalb des für die Frequenzmodulation reservierten, freien, ausfüllbaren Case-Feldes (\glqq FM\grqq ) wird die in \cref{FMFormel} auftretende Integration von $s(t)$ ermöglicht. % s.O. mit dem "frei, ausfüllbar" - Jannik: Ich hab's nur nochmal erwähnt, damit der Leser weiß, dass die oben angesprochenen Case-Felder gemeint sind. Leonut: finde ich komisch, aber w/e
	...
	% Blödsinn, dass auf das offensichtliche Englische zu übersetzen. Du schreibst doch auch nicht Satz von Rolle (Rolle's theorem) - Jannik: Das war nicht das Ziel. Ich wollte auf die entsprechende Stelle im Programmcode hinweisen, hätte ich eindeutiger machen sollen, sry.
