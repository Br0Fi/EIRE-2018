...
\fi
	...
	In \crefrange{fig_tag3_am_demod_eingang}{fig_tag3_am_demod_quadrat_vollst} sind die Graphen, die sich aus der durch den \enquote{Speichern}-Knopf erstellten Textdatei ergeben.
	...
	Diese müssen auf Störeffekte durch Netzspannung, deren Oberfrequenzen und andere Effekte bei der Erzeugung durch die Soundkarte zurückgeführt werden. %hab ich das nicht schon irgendwo geschrieben?
	%TODO hier verwendete Frequenzen angeben: i think: Träger 10.000Hz, Signale: 700Hz mit Ampl. 1 und 1000Hz bei Ampl. 3 mit m=0,2
...
\fi
	...
	\begin{figure}[H] %TODO Der tauscht die letzten beiden: Nach Text schreiben prüfen, maybe not
		\centering
		\begin{subfigure}[t]{0.5\textwidth}
			\centering
