...
%TODO am Ende: Begriffe vereinheitlichen und Größe von Grafiken anpassen
	...
	Um diesen Effekt zu minimieren können Fensterfunktionen angewendet werden. %TODO mit denen das Signal mutlipliziert wird? Wäre das immer wahr? - Jannik: Nach Wiki wird immer mit Fensterfunktion multipliziert.
...
\fi
	...
	\begin{figure}[H] %TODO Das ist doch bs, das abzubilden.schreib halt in das andere, dass der bei PM nur das Signal durchleitet. - Jannik: Hab ich unten auch hingeschrieben. Hab das Bild extra klein gemacht, ich finde das stört im Text jetzt auch nicht so wahnsinnig und zur Vollständigkeit gehört das schon irgendwie darein.
		\centering
	...
	Das sich ergebene phasenmodulierte Signal $S_{PM}(t)$ sowie dessen Fourier-Transformierte $\tilde{S}_{PM}(f)$ sind in den beiden Diagrammen auf der Benutzeroberfläche des Programms in \cref{PMAusgabe} dargestellt.
	...
	Das in \cref{FMPMDemodulation} entstandene Programm bildet die Basis für das folgende LabVIEW-Programm.
